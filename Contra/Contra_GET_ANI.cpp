...
int Get_CharANI_ID(int character, int behavior)
{
	...
	case SNIPER:
	{
		...
		arr[ACT_DIE_LEFT] = SNIPER_ANI_AIM_RIGHT;
		arr[ACT_DIE_RIGHT] = SNIPER_ANI_AIM_LEFT;
		arr[ACT_DIE_JUMPING_LEFT] = SNIPER_ANI_AIM_RIGHT;
		arr[ACT_DIE_JUMPING_RIGHT] = SNIPER_ANI_AIM_LEFT;
		break;
	}
