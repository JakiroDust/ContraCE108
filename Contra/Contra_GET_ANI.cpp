...
int Get_CharANI_ID(int character, int behavior)
{
	...
	case ALIEN_BASE:
	{
		arr[ACT_ACTIVE_LEFT] = ANI_ALIEN_BASE_MOUTH_CLOSE;
		arr[ACT_ACTIVE_RIGHT] = ANI_ALIEN_BASE_MOUTH_CLOSE;
		arr[ACT_STANDBY_LEFT] = ANI_ALIEN_BASE_MOUTH_OPEN;
		arr[ACT_STANDBY_RIGHT] = ANI_ALIEN_BASE_MOUTH_OPEN;
		arr[ACT_EMERGE_LEFT] = ANI_ALIEN_BASE_APPEAR;
		arr[ACT_EMERGE_RIGHT] = ANI_ALIEN_BASE_APPEAR;
		arr[ACT_HIDE_LEFT] = ANI_EMPTY;
		arr[ACT_HIDE_RIGHT] = ANI_EMPTY;
		arr[ACT_DIE_LEFT] = ANI_ALIEN_BASE_MOUTH_CLOSE;
		arr[ACT_DIE_RIGHT] = ANI_ALIEN_BASE_MOUTH_CLOSE;
		break;
	}

	case ALIEN_BASE_HANDCELL:
	{
		arr[ACT_ACTIVE_LEFT] = ANI_ALIEN_BASE_HAND_1;
		arr[ACT_ACTIVE_RIGHT] = ANI_ALIEN_BASE_HAND_1;
		arr[ACT_DIE_LEFT] = ANI_EMPTY;
		arr[ACT_DIE_RIGHT] = ANI_EMPTY;
		break;
	}

	case ALIEN_BASE_HANDCELL_MAIN:
	{
		arr[ACT_ACTIVE_LEFT] = ANI_ALIEN_BASE_HAND_2;
		arr[ACT_ACTIVE_RIGHT] = ANI_ALIEN_BASE_HAND_2;
		arr[ACT_DIE_LEFT] = ANI_EMPTY;
		arr[ACT_DIE_RIGHT] = ANI_EMPTY;
		break;
	}

	case ALIEN_BASE_HEAD:
	{
		return 0;
	}
