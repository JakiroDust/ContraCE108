...
int Get_CharANI_ID(int character, int behavior)
{
	...
	case TURRET:
	{
		arr[ACT_HIDE_LEFT] = ANI_TURRET_360_12;
		arr[ACT_HIDE_RIGHT] = ANI_TURRET_360_12;
		arr[ACT_EMERGE_LEFT] = ANI_TURRET_360_6;
		arr[ACT_EMERGE_RIGHT] = ANI_TURRET_360_6;
		...
		arr[ACT_DIE_LEFT] = ANI_TURRET_360_12;
		arr[ACT_DIE_RIGHT] = ANI_TURRET_360_12;
		break;
	}
