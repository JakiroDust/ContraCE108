...
void Obj_EnemyBullet_SBomb::Execute_BeforeDelete()
{
	if (_explodeFlag)
	{
		...
		bullets[0] = unique_ptr<Obj_EnemyBullet_SBomb_Phase2>(new Obj_EnemyBullet_SBomb_Phase2(x, y, Z_INDEX_ANIMATION, _hitPlatformID, -SBOMB_SPREAD_X, SBOMB_SPREAD_Y));
		bullets[1] = unique_ptr<Obj_EnemyBullet_SBomb_Phase2>(new Obj_EnemyBullet_SBomb_Phase2(x, y, Z_INDEX_ANIMATION, _hitPlatformID, 0, SBOMB_SPREAD_Y));
		bullets[2] = unique_ptr<Obj_EnemyBullet_SBomb_Phase2>(new Obj_EnemyBullet_SBomb_Phase2(x, y, Z_INDEX_ANIMATION, _hitPlatformID, SBOMB_SPREAD_X, SBOMB_SPREAD_Y));
		for (int i = 0; i < 3; i++)
		{
